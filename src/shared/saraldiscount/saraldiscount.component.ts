...
@Component({
  selector: 'app-saraldiscount',
  templateUrl: './saraldiscount.component.html',
  styleUrls: ['./saraldiscount.component.css']
})
export class SaraldiscountComponent {
  activeSection: string = 'cooperate'; // Default to Cooperate
